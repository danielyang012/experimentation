...
*   url_3_metric_name =
*   url_4_metric_name =
*   which_url_determines_conversion =
*   which_url_determines_denominator =
*   control_name


**Notes:**
*   For additional details on a function's documentation, utilize doc string  command
...
print("Writing experiment data to csv")
